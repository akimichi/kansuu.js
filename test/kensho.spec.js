...
describe("Kensho module", function() {
  it("ints", function(next) {
    ...
    expect(
      __.compose.call(__,__.stream.head)(__.compose.call(__,__.stream.tail)(__.stream.tail))(ints)
  ...
  it("randoms", function(next) {
    ...
    expect(
      __.stream.head.call(__,randStream)
      //randStream.value()
    ).to.be(
      0.038085370776470735
    );
    expect(
      __.compose.call(__,__.stream.head)(__.stream.tail)(randStream)
