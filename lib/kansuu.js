...
module.exports = {
  ...
  stream: {
    ...
    cons: function(any){
      ...
      return function(subsequent){
        ...
        var obj = {
          ...
          value: any,
          next : function(){
            return self.stream.cons.bind(self)(base.thunk(subsequent(any())))(subsequent);
          }
        };
        Object.freeze(obj);
        return obj;
    ...
    repeat: function(any){
      var self = this;
      return self.stream.cons.bind(self)(base.thunk(any))(self.id);
    },
    // stream.reduce
