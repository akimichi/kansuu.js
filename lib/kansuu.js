...
module.exports = {
  ...
  stream: {
    ...
    flatten: (stream) => {
      ...
      if(self.stream.isEmpty.call(self,stream)){
        ...
        return self.stream.censor.call(self,
                                       self.stream.append.call(self,
                                                               head)(self.stream.flatten.call(self,tail)));
      }
    ...
    flatMap: (stream) => {
      var self = this;
      self.stream.censor(stream);
      return self.stream.reduce.call(self,stream)(self.stream.empty)(self.stream.merge);
    },
    // ### stream#reduce
    reduce: (stream) => {
      var self = this;
