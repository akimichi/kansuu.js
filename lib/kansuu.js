	...
	mkStream: function(head){
	  ...
	  return function(tail){
		...
		var stream = {
		  ...
		  value : head,
		  next : function(){
			return self.stream.mkStream.bind(self)(tail(head))(tail);
		  },
		  take : function(n){
	...
	var self = this;
  	return function(accumulator){
		...
		if(self.isEmpty(mappable)) {
		  ...
		  //return glue(item)(self.reduce.bind(self)(self.tail.bind(self)(mappable))(accumulator)(glue));
		}
  	  };
	};
  },
