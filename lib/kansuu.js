  ...
  monad: {
	...
	maybeMonad: {
	  ...
	  getOrElse: (instance) => {
        var self = this;
		return (alternate) => {
	  	  return self.monad.maybeMonad.match(instance,{
	  		just: (value) => {
			  return value;
			},
	  		nothing: alternate
	  ...
	  isEqual: (maybeA) => {
        var self = this;
	  	return (maybeB) => {
	  	  return self.monad.maybeMonad.match(maybeA,{
	  		just: (valueA) => {
	  		  return self.monad.maybeMonad.match(maybeB,{
	  			just: (valueB) => {
	  		...
	  		nothing: self.monad.maybeMonad.match(maybeB,{
	  		  just: (_) => {
	  			return false;
	  		  },
	  		  nothing: true
      ...
      map: (maybe) => {
        ...
        return (transform) => {
          expect(transform).to.a('function');
		  return self.monad.maybeMonad.match(maybe,{
			just: (value) => {
