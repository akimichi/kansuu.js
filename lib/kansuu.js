...
module.exports = {
  ...
  //
  // 'stream' module c.f. https://gist.github.com/kana/5344530
  // 
  //
  stream: {
	...
	next: function (n) {
	  var self = this;
	  return self.stream.cons.bind(self)(n, this.stream.delay.bind(self)(function() {
		return self.stream.next.bind(self)(n + 1);
	  }));
	},
	...
	tail: function(stream) {
	  return this.stream.force.bind(this)(stream[1]);
	}
  },
  //
  // failure
