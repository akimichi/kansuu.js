...
module.exports = {
      ...
      return function(list){
        ...
        var instance = {
          ...
          isEqual: function(list){
            self.list.censor(list);
            return self.list.isEqual.bind(self)(instance)(list);
          }
        };
        return self.tap.call(self, instance)(function (target){
          Object.freeze(target);
  ...
  btree: {
    ...
    size: (btree) => {
      ...
      //   return self.btree.size.call(self, self.pair.left.call(self, btree.fork)) + self.btree.size.call(self, self.pair.right.call(self, btree.fork));
      // }
    },
    // ## btree#flatten
    // ~~~haskell
    ...
    map: (btree) => {
      ...
      return (transform) => {
        ...
        if(self.existy(btree.leaf)){
          return {
            type: 'btree',
            leaf: transform.call(self, btree.leaf),
            fork: base.nothing
          };
        } else {
          self.pair.censor.call(self,btree.fork);
   ...
   tail: (stream) => {
    ...
    cons: (head) => {
      ...
      return (tail) => {
        ...
        return self.stream.censor(self.tap.call(self, instance)(function (target){
          Object.freeze(target);
        }));
      };
    },
    ...
    //   var self = this;
    //   self.stream.censor(stream1);
    //   // zipExactly :: Stream[T] => Stream[U] => Maybe[Stream[Pair[T,U]]]
    //   var zipExactly = (streamA) => {
    //     self.stream.censor(streamA);
    //     return (streamB) => {
    //       self.stream.censor(streamB);
    //       if(self.stream.isEmpty.call(self,streamA) && self.stream.isEmpty.call(self,streamB)){
    //         return self.monad.maybe.unit.call(self, self.stream.empty);
    //       } else {
    //         if(self.stream.isEmpty.call(self,streamA)){
    //           return self.monad.maybe.nothing;
    //         }
    //         if(self.stream.isEmpty.call(self,streamB)){
    //           return self.monad.maybe.nothing;
    //         }
    //         var x = streamA.value;
    //         var xs = streamA.next;
    ...
    //         };
    //         return self.stream.cons.call(self,head)(function(){
    //           return zipExactly.call(self,xs())(ys());
    //         });
    //       }
    //     };
    //   };
