...
module.exports = {
  ...
  stream: {
    ...
    head: (stream) => {
      var self = this;
      return self.compose.call(self,self.stream.censor)(self.stream.force)(stream).value;
    ...
    tail: (stream) => {
      var self = this;
      return self,self.stream.force.call(self,
                                         (self.compose.call(self,self.stream.censor)(self.stream.force))(stream).next);
      // return self.stream.force.call(self,
      //                               self.stream.censor.call(self,
      //                                                       self.stream.force.call(self,
      //                                                                              stream)).next);
    ...
    mkStream: (array) => {
      ...
      if(array.length === 0){
        ...
        var head = self.head(array);
        var tail = () => {
          return self.stream.mkStream.call(self,self.tail(array));
          // return self.tail(array);
        };
        //return self.stream.cons.call(self,head)(self.tail(array));
