...
module.exports = {
  ...
  list: {
    ...
    reduce: function(list){
      var self = this;
      self.list.censor(list);
      expect(self.list.isNil(list)).to.not.be(true);
      return function(accumulator){
    ...
    reverse: function(list){
      ...
      if(self.list.isNil(list)){
		...
		// return self.list.reduce.bind(self)(list)(self.list.nil)(function(xs){
		//   return function(x){
    ...
    merge: function(listX) {
      ...
      return function(listY){
        ...
        if(self.list.isNil(listX)){
          return listY;
        }
        if(self.list.isNil(listY)){
          return listX;
        }
        var x = listX.head;
        var xs = listX.tail();
  ...
  stream: {
	...
	empty: function(){
      var self = this;
	  var fail = function(){
		throw new Error("next of empty stream should not be called");
	  };
