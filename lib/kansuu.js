	...
	mkList: function(array){
	  ...
	  var take = function(list){
		...
		return function(n) {
		  ...
		  if (n === 0) {
			...
			return [list.head].concat(take.bind(self)(list.tail.bind(self)())(n-1));
		  }
		};
	  };
		...
		var self = this;
  		return function(accumulator){
			...
			if(self.list.isNil(tail)) {
			  ...
			  return glue(item)(reduce.bind(self)(tail)(accumulator)(glue));
			}
  		  };
		};
	  };
	  var list = {
		...
		reduce : function(accumulator){
		  return function(glue){
			return reduce.bind(self)(list)(accumulator)(glue);
		  };
		},
		length : function(_){
		  return reduce.bind(self)(list)(0)(function(item){
			return function(accumulator){
